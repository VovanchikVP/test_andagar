...
class GetDateFile:
    ...
    def _root_element(self):
        """
        Получение названия корневого тега
        """
    ...
    def _data_element(self):
        """
        Парсинг заданных параметров.
        """
        # Содержимое тега data
        r_data = re.compile(r'<data.*?>(.*)</data>', re.I | re.M | re.S)
        s_data = r_data.search(self.file_data).group(1)
        
        # Данные из тега purchaseNumber вложенного в тег data
        ...
        # Данные из тега docPublishDate вложенного в тег data
        ...
        # Данные из тега purchaseObjectInfo вложенного в тег data
        ...
        # Данные из тега responsibleOrg вложенного в тег data
        ...
        # Данные из тега regNum вложенного в тег data/responsibleOrg
        ...
        # Данные из тега fullName вложенного в тег data/responsibleOrg
        ...
        # Данные из тега lot вложенного в тег data
        r_lot = re.compile(r'<.*?:lot>(.*)</.*?:lot>', re.I | re.M | re.S)
        s_lot = r_lot.search(s_data).group(1)
        
        # Данные из тега maxPrice вложенного в тег data/lot
    ...
    def _convert_date(self):
        """
        Формирует строку с датой для сохранения в базе данных из данных указанных в теге docPublishDate.
        """
